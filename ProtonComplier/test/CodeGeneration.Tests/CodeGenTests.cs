    ...
    public class CodeGenTests
    {
        ...
        private static readonly Dictionary<string, (bool IsSuccessful, string Result, int ErrorsCount)>
           ExpectedResults = new()
           {
                ...
                { "Ok20.prtn", (true, "Result: 1\r\n", 0) },
                { "Ok21.prtn", (true, "Result: 5\r\n", 0) },
                { "Ok22.prtn", (true, "Result: 6\r\n", 0) },
                { "Ok23.prtn", (true, "Result: 1\r\nResult: 4\r\n", 0) },
                { "Ok24.prtn", (true, "Result: osztó\r\nResult: osztó2\r\nResult: 23,5\r\nResult: 4545,56\r\n", 0) },
                { "Ok25.prtn", (true, "Result: 23,5\r\nResult: 4545,56\r\n", 0) },
                { "Ok26.prtn", (true, "Result: 23,5\r\nResult: False\r\nResult: 4545,56\r\n", 0) },
                { "Ok27.prtn", (true, "Result: 1\r\n", 0) },
                { "Ok28.prtn", (true, "Result: 1\r\nResult: 34,5\r\n", 0) },
                { "Ok29.prtn", (true, "Result: 1\r\nResult: 34,5\r\nResult: 20,4\r\n", 0) },
                { "Ok30.prtn", (true, "Result: 1\r\n", 0) },
                { "Ok31.prtn", (true, "Result: 2\r\n", 0) },
                { "Ok32.prtn", (true, "Result: 3\r\n", 0) },
                { "Ok33.prtn", (true, "Result: 3\r\nResult: 25\r\n", 0) },
                { "Ok34.prtn", (true, "Result: 7\r\n", 0) },
                { "Ok35.prtn", (true, "Result: 3\r\nResult: 6\r\n", 0) },
                { "Ok36.prtn", (true, "Result: 3\r\nResult: 6\r\nResult: -3\r\n", 0) },
                { "Ok37.prtn", (true, "Result: 4\r\nResult: 4\r\nResult: 0\r\n", 0) },
           };
